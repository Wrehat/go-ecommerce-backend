...
// Konstruktor untuk membuat instance baru dari ProductRepository
//
...
// Definisikan struktur untuk ProductRepository
//
//	type ProductRepository struct {
...
// Method untuk menambahkan produk baru ke repository
// func (r *productRepository) Create(product domain.Product) domain.Product {
// 	r.mu.Lock()
// 	r.idCounter++
// 	product.ID = r.idCounter
...
// func (r *productRepository) Update(id int, updateProduct domain.Product) (domain.Product, error) {
// 	r.mu.Lock()
// 	_, exists := r.db[id]
// 	if exists {
// 		updateProduct.ID = id
// 		r.db[id] = updateProduct
// 	}
// 	r.mu.Unlock()
